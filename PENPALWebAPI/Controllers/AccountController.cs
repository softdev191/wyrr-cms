...
using PENPALWebAPI.Providers;
using PENPALWebAPI.Results;
...
namespace PENPALWebAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        /// <returns></returns>
        //[HttpGet]
        //[Route("ValidateUser/{PhoneNumber}/{Password}")]
        //public async Task<ResponseWrapper<UserValidationAPIModel>> Login(string PhoneNumber, string Password)
        //{
        //    // Return Object
        ...
        //        #region ValidateUser
        //        result = ObjCustomer.Login(PhoneNumber, Password);
        //        #endregion
        ...
        //            lstUserValidation.Add(new UserValidationAPIModel { IsSuccess = true, UserID = result.UserID, UserName = result.UserName, Token = result.Token });
        ...
        //        else
        //        {
        //            lstUserValidation.Add(new UserValidationAPIModel { IsSuccess = false, UserID = 0, UserName = null });
