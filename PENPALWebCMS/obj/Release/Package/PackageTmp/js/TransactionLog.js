...
function LoadData() {
    ...
    $('#grid').dataTable({
        ...
        "bDestroy": true,
        "bProcessing": true,
        "sAjaxSource": "GetTransactionLogDetails",
        "aoColumns": [
                    ...
                    { "mDataProp": "AmountGiven" },
                    { "mDataProp": "CurrencyGiven" },
                    { "mDataProp": "AmountReceived" },
                    { "mDataProp": "CurrencyReceived" },
                    { "mDataProp": "PaypalClientMarginAmt" },
                    { "mDataProp": "PaypalMarginAmt" },
                    { "mDataProp": "ChangellyClientMarginAmt" },
                    { "mDataProp": "ChangellyMarginAmt" },
                    { "mDataProp": "TxnStatus" }
        ],
